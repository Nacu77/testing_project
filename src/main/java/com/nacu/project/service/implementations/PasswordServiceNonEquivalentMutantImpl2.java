...
@Service
@Profile("non_equivalent_mutant_not_killed_by_test")
public class PasswordServiceNonEquivalentMutantImpl2 implements PasswordService
{
    ...
    {
        return password.matches(".*[0-8].*"); // it was 0-9
    }
